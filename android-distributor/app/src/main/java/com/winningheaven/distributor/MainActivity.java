package com.winningheaven.distributor;
...
public class MainActivity extends BridgeActivity {
    ...
    private void lockWebViewZoom() {
        ...
        if (ua != null && !ua.contains("WinningHeavenDistributorNative")) {
            settings.setUserAgentString(ua + " WinningHeavenDistributorNative/1.0");
        } else if (ua != null && ua.matches(".*WinningHeavenDistributorNative/\\d+\\.\\d+.*")) {
            settings.setUserAgentString(
                ua.replaceAll("WinningHeavenDistributorNative/\\d+\\.\\d+", "WinningHeavenDistributorNative/1.0")
            );
        }
    }
